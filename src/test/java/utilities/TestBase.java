...
//===============Explicit Wait==============//
    public static WebElement waitForVisibility(WebElement element, int timeout) { //Beklemesini istedigim element, beklemesini istedigim sure
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeout));
        return wait.until(ExpectedConditions.visibilityOf(element));
    }
    public static WebElement waitForVisibility(By locator, int timeout) { //Bir locate icin bu kadar sure bekle
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeout));
        return wait.until(ExpectedConditions.visibilityOfElementLocated(locator));
    }
    public static WebElement waitForClickablility(WebElement element, int timeout) { //webelementin tiklanabilirligini su kadar sure bekle
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeout));
    ...
    public static void clickWithTimeOut(WebElement element, int timeout) { // Cok kullanilmaz
    ...
    public static void waitForPageToLoad(long timeout) { // Yeni sayfaya gecislerde kullanilabilir
