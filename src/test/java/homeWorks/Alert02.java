...
tıklayın ve result mesajında isminizin görüntülendiğini doğrulayın.
    ...
    public void acceptAlert(){
        ...
        Assert.assertEquals(expectedResultYazisi,actuelResultYazisi);
    ...
    public void test03(){
        ...
        driver.switchTo().alert().accept();
        WebElement sonucyazisiElementi= driver.findElement(By.xpath("//*[text()='You entered: Senem']"));
        String sonucYazisiStr= sonucyazisiElementi.getText();
        String girilenIsim="Senem";
